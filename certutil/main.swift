...
if(argCount == 3) {
    ...
    case "-list":
        ...
        for certificate in certificates {
            ...
            let dateStr = certificate.getDateFromIntSince2001(since2001: certificate.getExpirationDate())
...
if(errorFlag) {
    ...
    print("   certutil -count <name>      Count all certificates having <name> in CN")
    exit(EXIT_FAILURE)
}
